...
|---|---|---|
| Setup installer | Recommended for normal users | `CleanNet-2.1.2-setup.exe` |
...
2. Download `CleanNet-2.1.2-setup.exe`.
3. Run the installer.
...
1. Download `CleanNet-2.1.2-portable.zip` from GitHub Releases.
...
Get-FileHash .\CleanNet-2.1.2-portable.zip -Algorithm SHA256
Get-FileHash .\CleanNet-2.1.2-setup.exe -Algorithm SHA256
```
...
|---|---|---|
| Klasik setup installer | Normal kullanıcılar için önerilir | `CleanNet-2.1.2-setup.exe` |
...
2. `CleanNet-2.1.2-setup.exe` dosyasını indirin.
...
1. GitHub Releases içinden `CleanNet-2.1.2-portable.zip` dosyasını indirin.
...
|---|---|---|
| Setup Installer | Empfohlen für normale Nutzer | `CleanNet-2.1.2-setup.exe` |
...
2. Laden Sie `CleanNet-2.1.2-setup.exe` herunter.
...
1. Laden Sie `CleanNet-2.1.2-portable.zip` aus GitHub Releases herunter.
